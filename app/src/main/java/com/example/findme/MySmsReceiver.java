            ...
            if (bundle != null) {
                ...
                if (messages.length > -1) {
                    ...
                    if(messageBody.contains("Findme")){
                        //affichage notif
                        NotificationCompat.Builder mnotif = new NotificationCompat.Builder(
                                context, "CHANNEL_FINDME")
                                .setSmallIcon(android.R.drawable.ic_dialog_alert)
                                .setContentTitle("Nouvelle position reçu")
                                .setContentText(messageBody)
                                .setPriority(NotificationCompat.PRIORITY_DEFAULT)
                                .setVibrate(new long[]{1000,2000,500,1000});
                        Uri sound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_ALARM);
                        mnotif.setSound(sound);

                        Intent i = new Intent(context,Ajout.class);
                        i.putExtra("BODY",messageBody);//Findme#longitude#latitude
                ...
                if (messages.length > -1) {
                    ...
                    if(messageBody.contains("Findme"))
                    {
                        ...
                        NotificationCompat.Builder mnotif=new
                                NotificationCompat.Builder(context,"CHANNEL_FINDME");
